...
//            ImageUrl imageUrl=new ImageUrl(this.textField.getText());
    ...
    private void addProcessButtons(){
        ...
        buttons[0]=Helper.addButton(this,"Color shift",this.searchButton.getX(),this.searchButton.getY()+this.searchButton.getHeight()+Constants.TOP_MARGIN,Constants.TEXT_FIELD_WIDTH,Constants.TEXT_FIELD_HEIGHT);
